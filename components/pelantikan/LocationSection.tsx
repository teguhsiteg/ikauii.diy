      ...
      <div className="relative rounded-2xl bg-gradient-to-b from-[#0e2142]/90 to-[#081326]/95 border border-amber-400/35 p-5 sm:p-8 shadow-2xl backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <a
            ...
            href={getGoogleCalendarUrl(EVENT_DETAILS.title, EVENT_DETAILS.targetDateTime, EVENT_DETAILS.venue, EVENT_DETAILS.address)}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <button
            id="btn-download-ics"
            onClick={() => downloadIcsFile(EVENT_DETAILS.title, EVENT_DETAILS.targetDateTime, EVENT_DETAILS.venue, EVENT_DETAILS.address)}
